  ...
  <el-row style="align-items: center">
    <el-col :span="3">
        <el-dropdown>
            ...
            <template #dropdown>
            <el-dropdown-menu>
                <el-dropdown-item>解除限制</el-dropdown-item>
                <el-dropdown-item>封禁7天</el-dropdown-item>
                <el-dropdown-item>封禁30天</el-dropdown-item>
                <el-dropdown-item>永久封禁</el-dropdown-item>
            </el-dropdown-menu>
            </template>
        </el-dropdown>
    </el-col>
