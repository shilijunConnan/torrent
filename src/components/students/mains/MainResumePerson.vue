<template>
    ...
    <el-row class="globa_text_font">
        <el-col :span="4">
            <img class='img_4_3' src='https://tse3-mm.cn.bing.net/th/id/OIP-C.GWiyWYsP5R68bbTJ24gbLgHaJc?w=143&h=182&c=7&r=0&o=5&pid=1.7'/>
        </el-col>
        ...
        <el-col :span="20" v-if="edit_person">
            ...
            <el-row class="row_items">
                ...
                <el-col :span="2" class="global_right"><el-button @click="edit_person_handle">取消</el-button></el-col>
                <el-col :span="2" class="global_right"><el-button type="primary" @click="edit_person_handle">保存</el-button></el-col>
                
            </el-row>
        </el-col>
        <el-col :span="20" v-else>
                <h2>{{info.name}}&ensp;<el-icon size="20px"><edit class="globa_text_link" @click="edit_person_handle"></edit></el-icon></h2>
                {{info.sex}}&ensp;&ensp;&ensp;|
                &ensp;&ensp;&ensp;{{info.age}}&ensp;&ensp;&ensp;|
                &ensp;&ensp;&ensp;{{info.address}}&ensp;&ensp;&ensp;|
                &ensp;&ensp;&ensp;{{info.graduate}}&ensp;&ensp;&ensp;|
                &ensp;&ensp;&ensp;{{info.politics}}
                <br><br>联系电话：{{info.phone}}
        </el-col>
    </el-row>
